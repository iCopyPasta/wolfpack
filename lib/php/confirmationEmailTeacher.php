...
*/
    ...
    function sendMessage($connection, $email){
      ...
      $sql = "SELECT email,uniqueID FROM teacher_account WHERE email = '$email'";
      ...
      try{
        ...
        // fail JSON response
        $response = array();
        $response["message"] = "ERROR executing query $sql in confirmationEmailTeacher.php: ".$e->getMessage();
        $response["success"] = 0;
