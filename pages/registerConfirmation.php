...
*/
    ...
    function addUniqueHash($connection, $email){
      ...
      $sql = "UPDATE student_account SET uniqueID = '$hash' WHERE email = '$email'";
      ...
      try{
        ...
        // fail JSON response
        $response = array();
        $response["message"] = "ERROR executing query $sql in registerConfirmation.php: ".$hash." ".$e->getMessage();
        $response["success"] = 0;
